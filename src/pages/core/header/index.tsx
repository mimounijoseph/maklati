...
<nav className="border-gray-200 bg-transparent">
      ...
      {/* <ThemeSwitchIcon/> */}
        ...
        <div id="mega-menu" className="items-center justify-between hidden w-full md:flex md:w-auto md:order-1">
            <ul className="flex flex-col mt-4 font-medium md:flex-row md:mt-0 md:space-x-8 rtl:space-x-reverse">
                <li>
                    <a href="/" className="block py-2 px-3 text-white   border-b border-gray-100  hover:text-amber-600 md:border-0  md:p-0  " aria-current="page">Home</a>
                </li>
                <li>
                    {/* <button id="mega-menu-dropdown-button" data-dropdown-toggle="mega-menu-dropdown" className="flex items-center justify-between w-full py-2 px-3 font-medium text-gray-900 border-b border-gray-100 md:w-auto hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-blue-600 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-blue-500 md:dark:hover:bg-transparent dark:border-gray-700"> */}
                     <a href="/snack" className="block py-2 px-3 text-white border-b border-gray-100 hover:text-amber-600  md:border-0  md:p-0      ">Snacks</a>
                        {/* Menu  */}
  ...
  {/* </svg> */}
                ...
                {/* </li> */}
                <li>
                    <a href="/about" className="block py-2 px-3 text-white border-b border-gray-100 hover:text-amber-600  md:border-0  md:p-0">About</a>

                </li>
                <li>
                    <a href="/contact" className="block py-2 px-3 text-white border-b border-gray-100 hover:text-amber-600  md:border-0  md:p-0">Contact</a>

  ...
  return (
      <div className="min-h-screen text-white p-6">
          ...
          <header className="text-center mb-10">
              ...
              <p className="text-gray-400">Choose your favorite category</p>
          </header>
                  ...
                  <ul className="flex flex-wrap -mb-px text-sm font-medium text-center text-gray-500  dark:text-black">
                      <li className="me-2">
                          <a href="#"
                             className="inline-flex items-center justify-center p-4 border-b-2 border-transparent rounded-t-lg hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300 group">
                              <svg
                                  className="w-4 h-4 me-2 text-gray-400 group-hover:text-gray-500 dark:text-black dark:group-hover:text-gray-300"
                      ...
                      <li className="me-2">
                          <a href="#"
                             ...
                             aria-current="page">
                              <svg className="w-4 h-4 me-2 text-blue-600 dark:text-black" aria-hidden="true"

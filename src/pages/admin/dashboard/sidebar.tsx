...
import ProtectedPage from "@/guard/adminProtectedPage";
          ...
          <ul className="space-y-2  " style={{fontFamily: 'sans-serif'}} >
            ...
            <li>
              <a
                ...
                className={`flex items-center p-2 rounded-lg group transition-colors
                ${
                  pathname === "/admin/dashboard/addPlat"
                    ? " bg-orange-50 text-orange-500"
                    : "text-gray-900 hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
                }`}
              >
                ...
                <span className="flex-1 ms-3 whitespace-nowrap">Add plat</span>
              </a>
            </li>
            <li>
              <a
                ...
                className={`flex items-center p-2 rounded-lg group transition-colors
                ${
                  pathname === "/admin/dashboard/plats"
                    ? " bg-orange-50 text-orange-500"
                    : "text-gray-900 hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
                }`}
              >
              <svg className={`w-6 h-6 text-gray-800  ${
               ...
               aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                ...
                <span className="flex-1 ms-3 whitespace-nowrap">Plats</span>
              </a>
            </li>
            <li>
              <a
            ...
            <li>
              <a
                ...
                className={`flex items-center p-2 rounded-lg group transition-colors
                ${
                  pathname === "/admin/dashboard/snack"
                    ? " bg-orange-50 text-orange-500"
                    : "text-gray-900 hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
                }`}
              >
                ...
                <span className="flex-1 ms-3 whitespace-nowrap">Snack details</span>
              </a>
            </li>
            <li>
              <a
                ...
                className={`flex items-center p-2 rounded-lg group transition-colors
                ${
                  pathname === "/admin/dashboard/setting"
                    ? " bg-orange-50 text-orange-500"
                    : "text-gray-900 hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
                }`}
              >
            ...
            <li>
              <a
                href="#"
                className="flex items-center bg-gray-100 p-2 text-gray-400 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
              >
                ...
                <span className="flex-1 ms-3 whitespace-nowrap">Comming soon</span>
              </a>
            </li>
          </ul>
        </div>

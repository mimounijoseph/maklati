  ...
  (
    ...
    return (
      ...
      >
        ...
        <span className={cn("relative z-10 transition-all duration-300 flex items-center justify-center text-black", textEffect === "spread" && "group-hover:tracking-wider")}>{children}</span>
      </Comp>
    );
  }
);

  ...
  (
    ...
    return (
      ...
      >
        ...
        <div
          className="absolute -z-20  bg-amber-500"
          style={{ inset: shimmerSize, borderRadius }}
        />

        <InputComp
          className="h-full bg-transparent outline-none border-none relative z-10 text-inherit placeholder:text-white font-bold cursor-pointer"
          ref={ref}
          {...props}
        />
      </div>
